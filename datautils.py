...
class dataset:
    ...
    #MODIFIED GET DATA FOR SERVER.
    def getdataServer(self, dataFromClient, AllKinases, islabeled=False, MultiLabel=False):
        print("get data server called")
        """
        ...
        Sub_DS = dataFromClient #dataFromClient is an array of arrays. each array element is a row
